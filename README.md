...
What Format-only guarantees is therefore semantic rather than byte-level: your
words and your list numbering come through unchanged, and the file itself is
legitimately a different file. An untouched paragraph can still look different
on the page once the architect's defaults apply to it.

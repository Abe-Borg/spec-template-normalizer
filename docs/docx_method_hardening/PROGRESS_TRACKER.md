...
| WI-04 | Even-page header parity follows the architect | in_review | 04 | https://github.com/Abe-Borg/spec-template-normalizer/pull/64 | | The switch follows the header set (architect's when imported, the target's own otherwise); adjacent findings are listed in handoff 05. |
...
| 04 | 2026-09-25 | WI-04 | even/odd header parity follows the architect's header set; CT_Settings order table checked against ISO/IEC 29500-4; gate records header_parity_checked; PR opened; suite 1568 passed / 1 skipped (baseline 1506 / 1) | https://github.com/Abe-Borg/spec-template-normalizer/pull/64 | handoffs/handoff-for-session-05.md |

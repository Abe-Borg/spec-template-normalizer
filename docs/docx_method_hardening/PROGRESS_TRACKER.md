...
| WI-06 | Revision accounting, discarded-revision warnings, collision-proof revision ids | in_review | 06 | https://github.com/Abe-Borg/spec-template-normalizer/pull/66 | | Census of body revisions by author and kind against the predicted delta; header/footer revisions counted and warned; ids above every annotation id. The census now withholds a Format-only target whose w:numberingChange the numbering rewrite drops; adjacent findings are listed in handoff 07. |
...
| 06 | 2026-09-25 | WI-06 | revision census at the final gate with the predicted delta, per-paragraph own-revision check, header/footer revisions counted and warned, revision ids allocated above every annotation id; PR opened, one review finding fixed; suite 1640 passed / 1 skipped (baseline 1617 / 1) | https://github.com/Abe-Borg/spec-template-normalizer/pull/66 | handoffs/handoff-for-session-07.md |
